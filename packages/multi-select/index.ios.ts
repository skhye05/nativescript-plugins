...
export class MultiSelect {
    ...
    public show(options: MSOption): void {
        ...
        this.MSSelect.searchHintText = "text";
        ...
        if (options.onSearchTextChanged) {
            this.MSSelect.onSearchTextChanged = (searchText: string) => {
                options.onSearchTextChanged(searchText);
            };
        }
        ...
        if (options.onItemUnselected) {
            this.MSSelect.unselectedBlock = (item: any) => {
                options.onItemUnselected(options.bindValue ? options.items[item.multiSelectId][options.bindValue] : options.items[item.multiSelectId]);
            };
        }
